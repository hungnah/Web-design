...
- event_creation: Creating language exchange posts
...
# - event_creation: Creating posts and partner requests
...
INSTALLED_APPS = [
    ...
    'event_creation',    # Creating posts, partner requests
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'user_profile.context_processors.menu_language',
            ],
        },
    },
]
